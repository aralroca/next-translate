...
| `localesPath`     | A string with the directory of JSONs locales. For packages / yarn workspaces you should use the prefix "package:". This is needed for the "build step".                                                                                                                                                                                                                                                                                                                                                                                                                                                | `string`                        | `"locales"`                                                                     |
